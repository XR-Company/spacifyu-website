...
import spacifyuSymbol from "@/assets/spacifyu-symbol.png.asset.json";
      ...
      <div className="section-container">
        <motion.div
          ...
          <div className="relative w-32 h-32 md:w-40 md:h-40 mx-auto mb-10">
            ...
            <img src={spacifyuSymbol.url} alt="SpacifyU" className="relative w-full h-full rounded-[2.5rem]" />
          </div>
