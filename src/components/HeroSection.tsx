  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <motion.h1
          className="font-display text-[1.83rem] md:text-[3.3rem] lg:text-[4.28rem] font-semibold leading-tight mb-6 tracking-[0.02em] max-w-[330px] md:max-w-[460px] lg:max-w-[590px] mx-auto"
